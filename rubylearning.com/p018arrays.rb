...
var4 = [90.4, flavour, [true, false]]
puts var4[2]

# a trailing comma is ignored
name = ['Statish', 'Talim', 'Ruby', 'Java',]
puts name[0]
puts name[1]
puts name[2]
puts name[3]
