...
=begin
  Every object is "born" with certain innate abilitie.
  To see a list of innate methodsl you can call the mothods 
  mothod (and throw in a sort operation, to make it 
...
# If I now say
d1 = nil
# then the Dog object is abandoned and eligible for Garbage Collections (GC)
